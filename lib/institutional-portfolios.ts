...
export const INSTITUTIONAL_DATA: Institution[] = [
    {
        ...
        description: "Canada's leading robo-advisor uses a passive, index-based approach with a tilt towards low volatility.",
        portfolios: {
            Growth: {
                name: 'Growth',
                risk: 'Risk 8-10',
    ...
    },
    {
        ...
        description: "A strategic alliance between RBC Global Asset Management and BlackRock Canada, offering the popular 'X-Series' portfolios.",
        portfolios: {
            Growth: {
                name: 'Growth (XGRO)',
                risk: 'Risk 7-9',
                description: 'RBC iShares Core Growth ETF Portfolio. 80% Equity / 20% Fixed Income.',
                iconName: 'TrendingUp',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 37.1 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 20.3 },
                    { ticker: 'XEF.TO', name: 'iShares Core MSCI EAFE IMI', weight: 19.8 },
                    { ticker: 'XEC.TO', name: 'iShares Core MSCI Emerging Mkts', weight: 3.8 },
                    { ticker: 'XBB.TO', name: 'iShares Core Canadian Universe Bond', weight: 15.2 },
                    { ticker: 'XSH.TO', name: 'iShares Core Canadian Short Term Bond', weight: 3.8 },
                ]
            },
            Balanced: {
                name: 'Balanced (XBAL)',
                risk: 'Risk 4-6',
                description: 'RBC iShares Core Balanced ETF Portfolio. 60% Equity / 40% Fixed Income.',
                iconName: 'Scale',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 27.2 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 15.3 },
                    { ticker: 'XEF.TO', name: 'iShares Core MSCI EAFE IMI', weight: 14.8 },
                    { ticker: 'XEC.TO', name: 'iShares Core MSCI Emerging Mkts', weight: 2.7 },
                    { ticker: 'XBB.TO', name: 'iShares Core Canadian Universe Bond', weight: 32.0 },
                    { ticker: 'XSH.TO', name: 'iShares Core Canadian Short Term Bond', weight: 8.0 },
                ]
            },
            Conservative: {
                name: 'Conservative (XCNS)',
                risk: 'Risk 2-4',
                description: 'RBC iShares Core Conservative Balanced ETF Portfolio. 40% Equity / 60% Fixed Income.',
                iconName: 'Shield',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 18.1 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 10.1 },
                    { ticker: 'XEF.TO', name: 'iShares Core MSCI EAFE IMI', weight: 9.9 },
                    { ticker: 'XEC.TO', name: 'iShares Core MSCI Emerging Mkts', weight: 1.9 },
                    { ticker: 'XBB.TO', name: 'iShares Core Canadian Universe Bond', weight: 48.0 },
                    { ticker: 'XSH.TO', name: 'iShares Core Canadian Short Term Bond', weight: 12.0 },
                ]
            }
        }
    },
    {
        ...
        portfolios: {
            Growth: {
                name: 'Growth (TGRO)',
                risk: 'Risk 7-9',
                description: 'TD One-Click Aggressive ETF Portfolio. 90% Equity / 10% Fixed Income.',
                iconName: 'TrendingUp',
                holdings: [
                    { ticker: 'TPU.TO', name: 'TD US Equity Index ETF', weight: 42.0 },
                    { ticker: 'TTP.TO', name: 'TD Canadian Equity Index ETF', weight: 27.0 },
                    { ticker: 'TPE.TO', name: 'TD International Equity Index ETF', weight: 21.0 },
                    { ticker: 'TDB.TO', name: 'TD Canadian Aggregate Bond Index', weight: 10.0 },
                ]
            },
            Balanced: {
                name: 'Balanced (TBAL)',
                risk: 'Risk 4-6',
                description: 'TD One-Click Balanced ETF Portfolio. 60% Equity / 40% Fixed Income.',
                iconName: 'Scale',
                holdings: [
                    { ticker: 'TPU.TO', name: 'TD US Equity Index ETF', weight: 28.0 },
                    { ticker: 'TTP.TO', name: 'TD Canadian Equity Index ETF', weight: 18.0 },
                    { ticker: 'TPE.TO', name: 'TD International Equity Index ETF', weight: 14.0 },
                    { ticker: 'TDB.TO', name: 'TD Canadian Aggregate Bond Index', weight: 40.0 },
                ]
            },
            Conservative: {
                name: 'Conservative (TCON)',
                risk: 'Risk 2-4',
                description: 'TD One-Click Conservative ETF Portfolio. 40% Equity / 60% Fixed Income.',
                iconName: 'Shield',
                holdings: [
                    { ticker: 'TPU.TO', name: 'TD US Equity Index ETF', weight: 18.0 },
                    { ticker: 'TTP.TO', name: 'TD Canadian Equity Index ETF', weight: 12.0 },
                    { ticker: 'TPE.TO', name: 'TD International Equity Index ETF', weight: 10.0 },
                    { ticker: 'TDB.TO', name: 'TD Canadian Aggregate Bond Index', weight: 60.0 },
                ]
            }
        }
    },
        ...
        portfolios: {
            Growth: {
                ...
                holdings: [
                    ...
                    { ticker: 'ZCN.TO', name: 'BMO S&P/TSX Capped Composite', weight: 20.5 },
                    { ticker: 'ZEA.TO', name: 'BMO MSCI EAFE Index ETF', weight: 17.5 },
                    { ticker: 'ZEM.TO', name: 'BMO MSCI Emerging Markets Index', weight: 5.5 },
                    { ticker: 'ZAG.TO', name: 'BMO Aggregate Bond Index ETF', weight: 18.0 },
                    { ticker: 'ZMU.TO', name: 'BMO Mid-Term US IG Corp Bond', weight: 2.0 },
                ]
            },
            Balanced: {
                name: 'Balanced (ZBAL)',
                ...
                holdings: [
                    ...
                    { ticker: 'ZCN.TO', name: 'BMO S&P/TSX Capped Composite', weight: 15.5 },
                    { ticker: 'ZEA.TO', name: 'BMO MSCI EAFE Index ETF', weight: 13.0 },
                    { ticker: 'ZEM.TO', name: 'BMO MSCI Emerging Markets Index', weight: 4.0 },
                    { ticker: 'ZAG.TO', name: 'BMO Aggregate Bond Index ETF', weight: 36.0 },
                    { ticker: 'ZMU.TO', name: 'BMO Mid-Term US IG Corp Bond', weight: 4.0 },
                ]
            },
            Conservative: {
                ...
                holdings: [
                    ...
                    { ticker: 'ZCN.TO', name: 'BMO S&P/TSX Capped Composite', weight: 10.5 },
                    { ticker: 'ZEA.TO', name: 'BMO MSCI EAFE Index ETF', weight: 8.5 },
                    { ticker: 'ZEM.TO', name: 'BMO MSCI Emerging Markets Index', weight: 2.5 },
                    { ticker: 'ZAG.TO', name: 'BMO Aggregate Bond Index ETF', weight: 54.0 },
                    { ticker: 'ZMU.TO', name: 'BMO Mid-Term US IG Corp Bond', weight: 6.0 },
                ]
            }
        }
    },
    {
        ...
        description: "CIBC's Asset Allocation ETFs offer diversified portfolios with a focus on Canadian and Global markets.",
        portfolios: {
            Growth: {
                name: 'Growth (CGRW)',
                risk: 'Risk 7-9',
    ...
    },
    {
        ...
        description: "Scotia Index Tracker ETFs offer low-cost exposure to major market indices, combinable for custom portfolios.",
        portfolios: {
            Growth: {
    ...
    },
    {
        ...
        portfolios: {
            Growth: {
                name: 'Growth (VGRO)',
                risk: 'Risk 7-9',
                description: 'Standard 80/20 split. Uses broad-market index ETFs to capture global growth.',
                iconName: 'TrendingUp',
                holdings: [
                    { ticker: 'VUN.TO', name: 'Vanguard US Total Market', weight: 35.8 },
                    { ticker: 'VCN.TO', name: 'Vanguard FTSE Canada All Cap', weight: 23.5 },
                    { ticker: 'VIU.TO', name: 'Vanguard FTSE Dev All Cap ex NA', weight: 17.6 },
                    { ticker: 'VEE.TO', name: 'Vanguard FTSE Emerging Markets', weight: 5.6 },
                    { ticker: 'VAB.TO', name: 'Vanguard Canadian Aggregate Bond', weight: 11.8 },
                    { ticker: 'VBG.TO', name: 'Vanguard Global ex-Canada Bond', weight: 4.3 },
            ...
            Balanced: {
                name: 'Balanced (VBAL)',
                risk: 'Risk 4-6',
                description: 'Classic 60/40 portfolio. The benchmark for balanced investing.',
                iconName: 'Scale',
                holdings: [
                    { ticker: 'VUN.TO', name: 'Vanguard US Total Market', weight: 26.8 },
                    { ticker: 'VCN.TO', name: 'Vanguard FTSE Canada All Cap', weight: 17.7 },
                    { ticker: 'VIU.TO', name: 'Vanguard FTSE Dev All Cap ex NA', weight: 13.2 },
                    { ticker: 'VEE.TO', name: 'Vanguard FTSE Emerging Markets', weight: 4.2 },
                    { ticker: 'VAB.TO', name: 'Vanguard Canadian Aggregate Bond', weight: 23.6 },
                    { ticker: 'VBG.TO', name: 'Vanguard Global ex-Canada Bond', weight: 8.6 },
            ...
            Conservative: {
                ...
                risk: 'Risk 2-4',
                description: '40/60 split prioritizing income and stability over aggressive growth.',
                iconName: 'Shield',
                holdings: [
                    { ticker: 'VUN.TO', name: 'Vanguard US Total Market', weight: 17.9 },
                    { ticker: 'VCN.TO', name: 'Vanguard FTSE Canada All Cap', weight: 11.8 },
                    { ticker: 'VIU.TO', name: 'Vanguard FTSE Dev All Cap ex NA', weight: 8.8 },
                    { ticker: 'VEE.TO', name: 'Vanguard FTSE Emerging Markets', weight: 2.8 },
                    { ticker: 'VAB.TO', name: 'Vanguard Canadian Aggregate Bond', weight: 35.3 },
                    { ticker: 'VBG.TO', name: 'Vanguard Global ex-Canada Bond', weight: 12.9 },
                    { ticker: 'VBU.TO', name: 'Vanguard US Aggregate Bond', weight: 10.5 },
                ]
            }
        }
    },
    {
        ...
        portfolios: {
            Growth: {
                name: 'Growth (XGRO)',
                risk: 'Risk 7-9',
                description: '80% Equity / 20% Fixed Income. Broad diversification at a low cost.',
                iconName: 'TrendingUp',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 37.1 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 20.3 },
            ...
            Balanced: {
                name: 'Balanced (XBAL)',
                risk: 'Risk 4-6',
                description: '60% Equity / 40% Fixed Income. A simple one-ticket balanced solution.',
                iconName: 'Scale',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 27.2 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 15.3 },
            ...
            Conservative: {
                name: 'Conservative (XCNS)',
                risk: 'Risk 2-4',
                description: '40% Equity / 60% Fixed Income. Designed for capital preservation.',
                iconName: 'Shield',
                holdings: [
                    { ticker: 'ITOT', name: 'iShares Core S&P Total US Stock', weight: 18.1 },
                    { ticker: 'XIC.TO', name: 'iShares Core S&P/TSX Capped', weight: 10.1 },
